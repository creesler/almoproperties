...
export default function Home() {
  ...
  return (
    <main className="min-h-screen scroll-smooth">
      ...
      <header className="fixed w-full bg-navy-900 backdrop-blur-sm z-50">
        ...
        >
          <div className="container mx-auto px-4 py-4 flex flex-col gap-4">
            ...
            <Link 
              href="/login" 
              className="bg-yellow-400 text-black px-4 py-2 rounded-md hover:bg-yellow-500 inline-block text-center"
              onClick={() => setIsMobileMenuOpen(false)}
            >
              Login
            </Link>
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center z-20">
          <div className="max-w-3xl text-white">
            ...
            >
              <button
                onClick={() => openModal({
                  title: 'Get Started with Almo Properties',
                  description: 'Ready to begin your real estate journey? Our expert team is here to help you achieve your property goals. Contact us now for personalized assistance.',
                  details: {
                    location: '123 Business Street, City, Country',
                  }
                })}
                className="w-full md:w-auto bg-yellow-400 text-black px-8 py-4 rounded-md text-lg font-semibold hover:bg-yellow-500 inline-block transition-colors"
              >
                Get Started Now
              </button>
            </motion.div>
      ...
      <section className="relative py-12 md:py-20 bg-sky-100">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button
                    ...
                    className="w-full sm:w-auto bg-navy-900 text-white px-8 py-3 rounded-md hover:bg-navy-800 transition-colors text-center"
                  >
                    Contact Now
                  </button>
                  <button
                    ...
                    className="w-full sm:w-auto border-2 border-navy-900 text-navy-900 px-8 py-3 rounded-md hover:bg-navy-900 hover:text-white transition-colors text-center"
                  >
                    Learn More
                  </button>
                </div>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-12 md:py-20 bg-navy-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-8 md:mb-12">
      ...
      {/* Footer */}
      <footer className="bg-navy-900 text-white py-8 md:py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-center md:text-left">&copy; {new Date().getFullYear()} Almo Properties. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </main>
